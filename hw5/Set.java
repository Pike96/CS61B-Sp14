...
public class Set {
  ...
  public void union(Set s) {
    ...
    try {
      while (node.isValidNode()) {
        while (n.isValidNode()) {
          if (((Comparable) node.item()).compareTo(n.item()) == 0) {
            break;
          }
          else if (((Comparable) node.item()).compareTo(n.item()) < 0) {
            n.insertBefore(node.item());
            break;
          }
          else {
            n = n.next();
  ...
  public void intersect(Set s) {
    ...
    try {
      while (node.isValidNode()) {
        while (n.isValidNode() && ((Comparable) n.item()).compareTo(node.item()) <= 0) {
          if (((Comparable) node.item()).compareTo(n.item()) != 0) {
            n = n.next();
            n.prev().remove();
          }
