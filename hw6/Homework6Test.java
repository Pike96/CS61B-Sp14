...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    // from here.
    System.out.println("N = " + table.getN() + ", Size = " + table.getSize());
    System.out.println(table);
    System.out.println("Expected num of collisions: " + table.collision());
    System.out.println("Actual num of collisions: " + table.getNumCollision());

    numBoards = 200;
    table = new HashTableChained(numBoards);
    initTable(table, numBoards);
    System.out.println("\n" + "N = " + table.getN() + ", Size = " + table.getSize());
    System.out.println(table);
    System.out.println("Expected num of collisions: " + table.collision());
    System.out.println("Actual num of collisions: " + table.getNumCollision());
